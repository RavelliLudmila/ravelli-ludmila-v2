const AboutSection = () => {
    return (
        <section id="about" className="min-h-screen py-14 md:py-0 px-6 md:px-16 flex items-center justify-center overflow-hidden bg-background">
            <div className="max-w-4xl mx-auto w-full">
                ...
                <div className="space-y-4 text-base md:text-lg leading-relaxed text-foreground/90">
                    <p className="animate-slide-up">
                        Soy <strong>Ludmila Ravelli</strong>, desarrolladora frontend orientada a la creación de interfaces claras, estéticas y
                    ...
                    <div className="grid md:grid-cols-2 gap-4 mt-8 animate-slide-up" style={{ animationDelay: '0.4s' }}>
                        <div className="bg-muted/50 rounded-xl p-5">
                            <h3 className="text-lg font-semibold mb-2 text-secondary">Filosofía de trabajo</h3>
                        ...
                        <div className="bg-muted/50 rounded-xl p-5">
                            <h3 className="text-lg font-semibold mb-2 text-secondary">Valores</h3>
                            <p className="text-sm md:text-base">
