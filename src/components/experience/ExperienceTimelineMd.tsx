...
const experiences: ExperienceEntry[] = [
    ...
    },
    {
        ...
        width: '35%',
        anchor: 'center',
        stack: ['Next.js 15', 'Tailwind CSS', 'Figma', 'Framer Motion'],
    },
];
...
const timelinePoints: TimelinePoint[] = [
    ...
    },
    {
        ...
        connector: { direction: 'top', height: 50 },
        spanOffset: -65,
        spanPosition: 25,
    },
    {
    ...
    },
    {
        ...
        icon: <Briefcase className="h-6 w-6" />,
        connector: { direction: 'bottom', height: 50 },
        connector2: { direction: 'top', height: 50 },
        spanOffset: 65,
        spanPosition: 25,
    },
    {
            ...
            <div className="relative h-auto min-h-[400px]">
                ...
                {timelinePoints.map((point) => (
                    <div
                        ...
                        style={{ left: `${point.position}%`, top: '50%' }}
                    >
...
export default ExperienceTimelineMd;
